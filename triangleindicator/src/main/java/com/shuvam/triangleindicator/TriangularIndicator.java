package com.shuvam.triangleindicator;
...
public class TriangularIndicator extends View {
    ...
    public TriangularIndicator(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
    ...
    public TriangularIndicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    public TriangularIndicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
